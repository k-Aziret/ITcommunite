...
class UsersSearchListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs) # берет текст поиска который пришел
        context["search_text"] = self.request.GET.get("query") # отправляется на фронт часть, users.html 11-строка
        return context
